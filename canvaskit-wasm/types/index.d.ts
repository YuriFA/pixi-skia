...
export interface CanvasKit {
    ...
    readonly PdfDocument: DefaultConstructor<PdfDocument>;
}
...
export interface PdfDocument extends EmbindObject<"PdfDocument"> {
    /**
     * Returns a canvas on which to draw. When done drawing, call endPage()
     *
