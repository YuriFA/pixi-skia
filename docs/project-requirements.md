...
- Удобство использования приложения.
  Ожидаемый результат:
  Проект загруженный на github + работающая программа запущенная на любом бесплатном хостинге + pdf файл сгенерированный с помощью skia с векторной графикой.
